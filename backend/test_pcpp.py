...
# cpu = pcpp.part_search("processor", limit = 10)
...
# print(product1.price_list)
# print(product1.rating)
# print(product1.type)
# print(product1.url)


# cpus = pcpp.part_search("processor", limit = 100)

product = pcpp.fetch_product("https://pcpartpicker.com/product/7rXV3C/intel-core-i7-14700-21-ghz-20-core-processor-bx8071514700")
print(product)

# def extract_average_rating( rating_string):
...
#             print(rating_string)
#             rating = extract_average_rating(rating_string)
